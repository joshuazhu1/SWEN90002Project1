...
public class Delete extends HttpServlet {
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		db.deleteUser(email);
		out.println("<meta http-equiv=\"Refresh\" content=\"5;url=http://localhost:8080/InternetProj1/register.html\">");
		out.println("<p>");
		out.println("your registration records has been deleted, this page will be redirected to registration page ");
		out.println("</p>");
